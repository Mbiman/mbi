...
<head>
	...
	<style>
		.banner{
	height: 100vh;
	background: url("sports/bn2.jfif") no-repeat;
...
<body>
	<div id="container">
		...
		<div class="about">
					...
					<div class="title">Welcome To MBIMAN<i class="fa fa-cart-plus" ></i> Sporting Category</div>
		...
		<ul class="page">
			...
			<li><a href="sports2.html">Page 2</a></li>
