...
<head>
	...
	<style>
		.banner{
	height: 100vh;
	background: url("Laptop/banlap.jfif") no-repeat;
...
<body>
	<div id="container">
		...
		<div class="about">
					...
					<div class="title">Welcome To MBIMAN<i class="fa fa-cart-plus" ></i> Laptops Category</div>
		...
		<ul class="page">
			...
			<li><a href="laptop2.html">Page 2</a></li>
