...
<head>
	...
	<style>
		.banner{
	height: 100vh;
	background: url("home/bn.jpg") no-repeat;
...
<body>
	<div id="container">
		...
		<div class="about">
					...
					<div class="title">Welcome To MBIMAN<i class="fa fa-cart-plus" ></i> Home Appliance Category</div>
		...
		<ul class="page">
			...
			<li><a href="home2.html">Page 2</a></li>
