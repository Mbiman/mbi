...
<head>
	...
	<style>
		.banner{
	height: 100vh;
	background: url("soccer/bn.png") no-repeat;
...
<body>
	<div id="container">
		...
		<div class="about">
					...
					<div class="title">Welcome To MBIMAN<i class="fa fa-cart-plus" ></i> Soccer Category</div>
		...
		<ul class="page">
			...
			<li><a href="soccer2.html">Page 2</a></li>
